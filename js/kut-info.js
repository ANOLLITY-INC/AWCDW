...
// 옛 자료에 다른 표기로 적힌 이름 — 그 표기로 검색해도 찾히도록 별칭 처리(표시는 확정 표기)
const KUT_NAME_ALIAS = { '홍찬민': ['홍창민'] };  // 옛 표기(홍창민)로 검색해도 찾히도록
