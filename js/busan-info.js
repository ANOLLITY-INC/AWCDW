...
const BUSAN_ROOM_UNUSED = []; // 숙소 미이용 없음 — 2026-07-13 전원 배정 완료(기존 미이용 9명을 잔여 호실에 배정)

// 방 이니셜(숙소 구분) 설명 + 호텔
//  ※ B(W레지던스 호텔 해운대)는 전원 어반스테이로 이동해 더 이상 사용하지 않습니다.
...
const URBANSTAY_ROOM_DETAIL = {
  ...
  // 배정표에 예약돼 있었으나 미등록이던 ST 1실(2026-07-13 추가) — 황세현(기존 B타입 잔류) + 조민우
  'A-9': { no: '911',  pw: '817442*' },
  // C 타입 (S) — 더블베드 1개
